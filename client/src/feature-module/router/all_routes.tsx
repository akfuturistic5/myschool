...
// dashboard routes
  ...
  studentHomeworkDetail: "/student/homework/:id",
  parentHomework: "/parent/homework",
  parentHomeworkDetail: "/parent/homework/:id",
  ...
  administrativeDetails: "/administrative/my-details",
  administrativeLeaves: "/administrative/my-leaves",
  ...
  libraryCategories:"/management/library-categories",
  libraryPolicies:"/management/library-policies",
  libraryIssueBook:"/management/library-issue-book",
  libraryBooks:"/management/library-books",
  libraryBookCopies:"/management/library-book-copies",
  libraryReturn:"/management/library-return",
  libraryReservations:"/management/library-reservations",
  ...
  hostelFloors:"/management/hostel-floors",
  hostelBeds:"/management/hostel-beds",
  hostelAssignments:"/management/hostel-assignments",
  ...
  classHomeWorkDetail: "/academic/class-home-work/:id",
  exam: "/academic/exam",
  ...
  leaveTypesManage: "/hrm/leave-types",
  ...
  accountCategories: "/accounts/categories",
  expenseCategory: "/accounts/categories",
