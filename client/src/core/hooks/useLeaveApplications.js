...
export const useLeaveApplications = (options = {}) => {
  ...
  useEffect(() => {
    fetchList(false);
  }, [limit, studentOnly, includeAutoGenerated, parentChildren, studentId, staffId, canUseAdminList, classId, sectionId, departmentId, designationId, academicYearId, leaveFrom, leaveTo, pendingOnly, status, leaveTypeId, applicantType, sortBy, sortOrder, page, pageSize]);
