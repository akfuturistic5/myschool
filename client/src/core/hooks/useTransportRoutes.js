    ...
    try {
      ...
      if (Array.isArray(list)) {
        const mapped = list.map((row, index) => ({
          ...
          pickup_start_time: row.pickup_start_time ?? row.start_time ?? row.start_point ?? '',
          pickup_end_time: row.pickup_end_time ?? row.end_time ?? row.end_point ?? '',
          drop_start_time: row.drop_start_time ?? '',
          drop_end_time: row.drop_end_time ?? '',
          start_time: row.pickup_start_time ?? row.start_time ?? row.start_point ?? '',
          end_time: row.pickup_end_time ?? row.end_time ?? row.end_point ?? '',
