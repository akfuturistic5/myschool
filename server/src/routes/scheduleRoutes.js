...
const { getAllSchedules, getScheduleById, createSchedule, updateSchedule, deleteSchedule, bulkGenerateSchedules, bulkDeleteSchedules } = require('../controllers/scheduleController');
...
router.post('/generate', requireRole([ROLES.ADMIN]), bulkGenerateSchedules);
router.post('/bulk-delete', requireRole([ROLES.ADMIN]), bulkDeleteSchedules);
