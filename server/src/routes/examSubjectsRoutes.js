...
router.post('/save', requireRole([...EXAM_ADMIN_ROLES, ROLES.TEACHER]), saveExamSubjectSetup);
router.get('/marks-context', requireRole([...EXAM_ADMIN_ROLES, ROLES.TEACHER]), getExamMarksContext);
router.post('/marks-save', requireRole([...EXAM_ADMIN_ROLES, ROLES.TEACHER]), saveExamMarks);
