...
const { NOTICE_MANAGER_ROLES, ALL_AUTHENTICATED_ROLES } = require('../config/roles');
const {
  getAllNotices,
  getNoticeById,
  createNotice,
...
router.get('/', requireRole(ALL_AUTHENTICATED_ROLES), getAllNotices);
router.get('/:id', requireRole(ALL_AUTHENTICATED_ROLES), getNoticeById);
