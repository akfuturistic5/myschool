...
const classSectionRoutes = require('./src/routes/classSectionRoutes');
...
const hostelRoomTypeRoutes = require('./src/routes/hostelRoomTypeRoutes');
const hostelAssignmentRoutes = require('./src/routes/hostelAssignmentRoutes');
const hostelFloorRoutes = require('./src/routes/hostelFloorRoutes');
const hostelBedRoutes = require('./src/routes/hostelBedRoutes');
...
const classSubjectRoutes = require('./src/routes/classSubjectRoutes');
const electiveGroupRoutes = require('./src/routes/electiveGroupRoutes');
...
app.use('/api/elective-groups', electiveGroupRoutes);
...
app.use('/api/hostel-room-types', hostelRoomTypeRoutes);
app.use('/api/hostel-assignments', hostelAssignmentRoutes);
app.use('/api/hostel-floors', hostelFloorRoutes);
