...
COMMENT ON TABLE public.student_hostel_assignments IS
    'Legacy logistics placeholder; superseded by hostel_assignments when the hierarchical hostel module is provisioned.';

-- =============================================================================
-- HOSTEL MODULE (phase 1) — occupancy via hostel_beds + hostel_assignments
-- =============================================================================
...
ON public.hostel_floors (hostel_id, floor_number) WHERE deleted_at IS NULL;
...
ON public.hostel_rooms (hostel_id, room_number) WHERE deleted_at IS NULL;
...
ON public.hostel_beds (room_id, bed_number) WHERE deleted_at IS NULL;
...
CREATE TABLE IF NOT EXISTS public.hostel_assignments (
    id SERIAL PRIMARY KEY,
    academic_year_id integer NOT NULL REFERENCES public.academic_years(id) ON DELETE RESTRICT,
    user_type character varying(20) NOT NULL CHECK (user_type IN ('student', 'staff')),
