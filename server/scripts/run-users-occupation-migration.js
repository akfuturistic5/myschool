/**
 * Applies 021_users_occupation.sql (idempotent).
 *
 *   npm run db:migrate:users-occupation
 */
...
async function main() {
  ...
  const sqlPath = path.join(__dirname, '..', 'migrations', '021_users_occupation.sql');
  const sql = fs.readFileSync(sqlPath, 'utf8');
  console.log('Applying 021_users_occupation.sql ...');
